...
#### nixos-rebuild
```
sudo nixos-rebuild dry-activate --impure --refresh --flake github:denver-cfman/nixos-systems?ref=main#pine64-plus --no-write-lock-file
```
#### Build sd-image (for flashing on [Pine64+](https://discourse.nixos.org/t/pine64-device-images/15699))
```
sudo nix build --impure --refresh --rebuild --no-update-lock-file -L -v github:denver-cfman/nixos-systems?ref=main#nixosConfigurations.pine64-plus.config.system.build.sdImage
```
